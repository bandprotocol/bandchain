...
class TestStdReferenceBasic(ScoreTestCase):
    ...
    def _set_test_data(self):
        self.score._set_refs("BTC", 10_953_310_000_000, 1_600_419_436)
        self.score._set_refs("ETH", 386_084_000_000, 1_600_419_436)
        self.score._set_refs("SUSD", 1_003_000_000, 1_600_419_716)

    def test_get_ref_data(self):
        self.assertEqual(
            {"rate": self.score.ONE, "last_update": self.score.block.timestamp},
        ...
        self.assertEqual(
            {"rate": 10_953_310_000_000, "last_update": 1_600_419_436_000_000},
            self.score._get_ref_data("BTC"),
        )
        self.score._set_refs("ETH", 386_084_000_000, 1_600_419_436)
        self.assertEqual(
            {"rate": 1_003_000_000, "last_update": 1_600_419_716_000_000},
            self.score._get_ref_data("SUSD"),
        )
