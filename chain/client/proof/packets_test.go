...
func TestCalculateResultHash(t *testing.T) {
	...
	fmt.Println(hex.EncodeToString(oracle.ModuleCdc.MustMarshalBinaryBare(reqPacket)))
	fmt.Println(hex.EncodeToString(oracle.ModuleCdc.MustMarshalBinaryBare(resPacket)))
	panic("yo")
