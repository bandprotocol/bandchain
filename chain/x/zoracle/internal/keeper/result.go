...
func (k Keeper) SetResult(ctx sdk.Context, requestID uint64, codeHash []byte, params []byte, result []byte) {
...
func (k Keeper) HasResult(ctx sdk.Context, requestID uint64, codeHash []byte, params []byte) bool {
	store := ctx.KVStore(k.storeKey)
