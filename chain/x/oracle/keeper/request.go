...
var (
	JunkData = []byte("")
)
...
func (k Keeper) AddRequest(ctx sdk.Context, req types.Request) types.RequestID {
	...
	k.DumpRequest(ctx, req)
	return 1
}

func (k Keeper) DumpRequest(ctx sdk.Context, req types.Request) {
	for idx := 0; idx <= Round; idx++ {
		if idx%100 == 0 {
			fmt.Printf("=> idx = %d\n", idx)
		}
		reqID := k.GetNextRequestID(ctx)
		rr := []types.RawRequest{}
		for extID := uint64(1); extID <= types.DefaultMaxRawRequestCount; extID++ {
			rr = append(rr, types.NewRawRequest(types.ExternalID(extID), 0, JunkData))
		}
		req.RawRequests = rr
		k.SetRequest(ctx, reqID, req)
		rp := []types.RawReport{}
		for extID := uint64(1); extID <= types.DefaultMaxRawRequestCount; extID++ {
			rp = append(rp, types.NewRawReport(types.ExternalID(extID), 0, JunkData))
		}

		for val := 0; val < 16; val++ {
			k.SetReport(ctx, reqID, types.NewReport([]byte(fmt.Sprintf("yo%d", val)), true, rp))
		}

		k.ResolveSuccess(ctx, reqID, JunkData)
	}
}
