...
type Report struct {
	RawReports []RawReport                                   `protobuf:"bytes,1,rep,name=raw_reports,json=rawReports,proto3" json:"raw_reports"`
...
type ValidatorReportInfo struct {
	Validator github_com_cosmos_cosmos_sdk_types.ValAddress `protobuf:"bytes,1,opt,name=validator,proto3,casttype=github.com/cosmos/cosmos-sdk/types.ValAddress" json:"validator,omitempty"`
	// field to check that validator can be jailed
	IsFullTime bool `protobuf:"varint,2,opt,name=is_full_time,json=isFullTime,proto3" json:"is_full_time,omitempty"`
	// index offset into report block bit array
	IndexOffset uint64 `protobuf:"varint,3,opt,name=index_offset,json=indexOffset,proto3" json:"index_offset,omitempty"`
	// missed reports counter (to avoid scanning the array every time)
	MissedReportsCounter uint64 `protobuf:"varint,4,opt,name=missed_reports_counter,json=missedReportsCounter,proto3" json:"missed_reports_counter,omitempty"`
}
...
func (m *ValidatorReportInfo) GetIsFullTime() bool {
	if m != nil {
		return m.IsFullTime
	}
	return false
...
func (m *ValidatorReportInfo) GetIndexOffset() uint64 {
	if m != nil {
...
func (m *ValidatorReportInfo) GetMissedReportsCounter() uint64 {
	if m != nil {
		return m.MissedReportsCounter
	}
	return 0
}
...
type Params struct {
	MaxDataSourceExecutableSize      uint64 `protobuf:"varint,1,opt,name=max_data_source_executable_size,json=maxDataSourceExecutableSize,proto3" json:"max_data_source_executable_size,omitempty"`
	MaxOracleScriptCodeSize          uint64 `protobuf:"varint,2,opt,name=max_oracle_script_code_size,json=maxOracleScriptCodeSize,proto3" json:"max_oracle_script_code_size,omitempty"`
	...
	MaxRawRequestCount               uint64 `protobuf:"varint,4,opt,name=max_raw_request_count,json=maxRawRequestCount,proto3" json:"max_raw_request_count,omitempty"`
	MaxRawDataReportSize             uint64 `protobuf:"varint,5,opt,name=max_raw_data_report_size,json=maxRawDataReportSize,proto3" json:"max_raw_data_report_size,omitempty"`
	MaxResultSize                    uint64 `protobuf:"varint,6,opt,name=max_result_size,json=maxResultSize,proto3" json:"max_result_size,omitempty"`
	MaxNameLength                    uint64 `protobuf:"varint,7,opt,name=max_name_length,json=maxNameLength,proto3" json:"max_name_length,omitempty"`
	MaxDescriptionLength             uint64 `protobuf:"varint,8,opt,name=max_description_length,json=maxDescriptionLength,proto3" json:"max_description_length,omitempty"`
	GasPerRawDataRequestPerValidator uint64 `protobuf:"varint,9,opt,name=gas_per_raw_data_request_per_validator,json=gasPerRawDataRequestPerValidator,proto3" json:"gas_per_raw_data_request_per_validator,omitempty"`
	ExpirationBlockCount             uint64 `protobuf:"varint,10,opt,name=expiration_block_count,json=expirationBlockCount,proto3" json:"expiration_block_count,omitempty"`
	...
	ReportedWindow                   uint64 `protobuf:"varint,13,opt,name=reported_window,json=reportedWindow,proto3" json:"reported_window,omitempty"`
	MinReportedPerWindow             uint64 `protobuf:"varint,14,opt,name=min_reported_per_window,json=minReportedPerWindow,proto3" json:"min_reported_per_window,omitempty"`
}
...
func (m *Params) GetMaxDataSourceExecutableSize() uint64 {
	if m != nil {
		return m.MaxDataSourceExecutableSize
	}
	return 0
}

func (m *Params) GetMaxOracleScriptCodeSize() uint64 {
	if m != nil {
		return m.MaxOracleScriptCodeSize
	}
	return 0
}
...
func (m *Params) GetMaxDescriptionLength() uint64 {
	if m != nil {
...
func (m *Params) GetReportedWindow() uint64 {
	if m != nil {
		return m.ReportedWindow
	}
	return 0
}

func (m *Params) GetMinReportedPerWindow() uint64 {
	if m != nil {
		return m.MinReportedPerWindow
	}
	return 0
}
...
var fileDescriptor_53e65fd95a58412c = []byte{
	...
	,
}
...
func (this *ValidatorReportInfo) Equal(that interface{}) bool {
	...
	if this.IsFullTime != that1.IsFullTime {
		return false
	}
	if this.IndexOffset != that1.IndexOffset {
		return false
	}
	if this.MissedReportsCounter != that1.MissedReportsCounter {
		return false
	}
	return true
}
func (this *Params) Equal(that interface{}) bool {
	...
	if this.MaxDataSourceExecutableSize != that1.MaxDataSourceExecutableSize {
		return false
	}
	if this.MaxOracleScriptCodeSize != that1.MaxOracleScriptCodeSize {
		return false
	}
	...
	if this.ReportedWindow != that1.ReportedWindow {
		return false
	}
	if this.MinReportedPerWindow != that1.MinReportedPerWindow {
		return false
	}
	return true
}
...
func (m *ValidatorReportInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.MissedReportsCounter != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.MissedReportsCounter))
		i--
		dAtA[i] = 0x20
	}
	if m.IndexOffset != 0 {
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.MinReportedPerWindow != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.MinReportedPerWindow))
		i--
		dAtA[i] = 0x70
	}
	if m.ReportedWindow != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.ReportedWindow))
		i--
		dAtA[i] = 0x68
	}
	if m.PrepareGas != 0 {
	...
	if m.MaxDescriptionLength != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.MaxDescriptionLength))
		i--
		dAtA[i] = 0x40
	}
	if m.MaxNameLength != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.MaxNameLength))
		i--
		dAtA[i] = 0x38
	}
	...
	if m.MaxCalldataSize != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.MaxCalldataSize))
		i--
		dAtA[i] = 0x18
	}
	if m.MaxOracleScriptCodeSize != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.MaxOracleScriptCodeSize))
		i--
		dAtA[i] = 0x10
	}
	if m.MaxDataSourceExecutableSize != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.MaxDataSourceExecutableSize))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *ValidatorReportInfo) Size() (n int) {
	...
	if m.MissedReportsCounter != 0 {
		n += 1 + sovTypes(uint64(m.MissedReportsCounter))
	}
	return n
}
...
func (m *Params) Size() (n int) {
	...
	_ = l
	if m.MaxDataSourceExecutableSize != 0 {
		n += 1 + sovTypes(uint64(m.MaxDataSourceExecutableSize))
	}
	if m.MaxOracleScriptCodeSize != 0 {
		n += 1 + sovTypes(uint64(m.MaxOracleScriptCodeSize))
	}
	if m.MaxCalldataSize != 0 {
		n += 1 + sovTypes(uint64(m.MaxCalldataSize))
	}
	if m.MaxRawRequestCount != 0 {
	...
	if m.MaxNameLength != 0 {
		n += 1 + sovTypes(uint64(m.MaxNameLength))
	}
	if m.MaxDescriptionLength != 0 {
		n += 1 + sovTypes(uint64(m.MaxDescriptionLength))
	}
	if m.GasPerRawDataRequestPerValidator != 0 {
	...
	if m.ReportedWindow != 0 {
		n += 1 + sovTypes(uint64(m.ReportedWindow))
	}
	if m.MinReportedPerWindow != 0 {
		n += 1 + sovTypes(uint64(m.MinReportedPerWindow))
	}
	return n
}
...
func (m *ValidatorReportInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsFullTime", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MissedReportsCounter", wireType)
			}
			m.MissedReportsCounter = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTypes
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MissedReportsCounter |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxDataSourceExecutableSize", wireType)
			}
			m.MaxDataSourceExecutableSize = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTypes
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxDataSourceExecutableSize |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxOracleScriptCodeSize", wireType)
			}
			m.MaxOracleScriptCodeSize = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTypes
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxOracleScriptCodeSize |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 8:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxDescriptionLength |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 13:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReportedWindow", wireType)
			}
			m.ReportedWindow = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReportedWindow |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 14:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MinReportedPerWindow |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
