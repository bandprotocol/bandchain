...
func TestRequestSuccess(t *testing.T) {
	...
	msg := types.NewMsgRequestData(1, calldata, 2, 2, 1000000, 1000000, "clientID", sender)
	...
	expectRequest := types.NewRequest(1, calldata,
		...
		2, 1581589790, 22, 1000000, "clientID",
	)
...
func TestRequestInvalidDataSource(t *testing.T) {
	...
	msg := types.NewMsgRequestData(1, calldata, 2, 2, 30, 20000, "clientID", sender)
	_, err := handleMsgRequestData(ctx, keeper, msg)
	require.NotNil(t, err)
...
func TestRequestWithPrepareGasExceed(t *testing.T) {
	...
	msg := types.NewMsgRequestData(1, calldata, 2, 2, 3, 1000000, "clientID", sender)
...
func TestEndBlock(t *testing.T) {
	...
	msg := types.NewMsgRequestData(1, calldata, 2, 2, 30, 2500, "clientID", sender)
...
func TestEndBlockExecuteFailedIfExecuteGasLessThanGasUsed(t *testing.T) {
	...
	msg := types.NewMsgRequestData(1, calldata, 2, 2, 500, 500, "clientID", sender)
...
func TestSkipInvalidExecuteGas(t *testing.T) {
	...
	msg := types.NewMsgRequestData(1, calldata, 2, 2, 1000000, 100000, "clientID", sender)
	handleMsgRequestData(ctx, keeper, msg)

	msg = types.NewMsgRequestData(1, calldata, 2, 2, 1000000, 50000, "clientID", sender)
	handleMsgRequestData(ctx, keeper, msg)
...
func TestStopResolveWhenOutOfGas(t *testing.T) {
	...
	for i := types.RequestID(1); i <= types.RequestID(10); i++ {
		handleMsgRequestData(
			ctx, keeper,
			types.NewMsgRequestData(scriptID, calldata, 2, 2, 2000, 2500, "clientID", sender),
		)
...
func TestEndBlockInsufficientExecutionConsumeEndBlockGas(t *testing.T) {
	...
	for i := types.RequestID(1); i <= types.RequestID(4); i++ {
		handleMsgRequestData(
			ctx, keeper,
			types.NewMsgRequestData(scriptID, calldata, 2, 2, 2000, executeGasList[i-1], "clientID", sender),
		)
