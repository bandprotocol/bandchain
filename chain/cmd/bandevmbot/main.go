...
func update_validator(rpcURI string, address string, node string, privateKey string, gasPrice uint64) {
...
func main() {
	...
	cmd := &cobra.Command{
		Use:   "update-validator [rpc-uri] [contract-address] [node-uri] [priv-key] [gas-price] [poll-interval] ",
...
Example:
$ update-validator https://kovan.infura.io/v3/d3301689638b40dabad8395bf00d3945 0x0d8152D22a05A3Cf2cE1c5bEfCc2F8658f75a59d http://d3n-debug.bandprotocol.com:26657 AA0C65C16D4B8511C58122966F94192F6963D0EB7896435430BCDFF56E9F13B9 24
`),
		),
		RunE: func(cmd *cobra.Command, args []string) error {
			gasPrice, err := strconv.ParseInt(args[4], 10, 64)
			if err != nil {
				return err
			}
			...
			for {
				update_validator(args[0], args[1], args[2], args[3], uint64(gasPrice))
