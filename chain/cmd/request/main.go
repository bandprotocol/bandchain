	...
	case "store":
		{
			...
			fmt.Println(tx.SendTransaction(
				oracle.NewMsgCreateOracleScript(
					...
					oracleBytes, tx.Sender(), `{"Input": "{ \\"kind\\": \\"struct\\", \\"fields\\": [ [\\"symbol\\", \\"string\\"], [\\"multiplier\\", \\"u64\\"] ] }", "Output": "{ \\"kind\\": \\"struct\\", \\"fields\\": [ [\\"px\\", \\"u64\\"] ] }`, "sourceCodeURL",
				),
				3000000, "", "",
			))
		}
	...
	case "example-test":
		{
			...
			fmt.Println(tx.SendTransaction(
				oracle.NewMsgCreateOracleScript(
					tx.Sender(), "Silly script", "Test oracle script", bytes, tx.Sender(), `{"Input": "{ \\"kind\\": \\"struct\\", \\"fields\\": [ [\\"symbol\\", \\"string\\"], [\\"multiplier\\", \\"u64\\"] ] }", "Output": "{ \\"kind\\": \\"struct\\", \\"fields\\": [ [\\"px\\", \\"u64\\"] ] }`, "sourceCodeURL"),
				3000000, "", "",
			))
			...
			for i := uint64(0); i < round; i++ {
				fmt.Println(tx.SendTransaction(
					oracle.NewMsgCreateOracleScript(
						...
						bytes, tx.Sender(), `{"Input": "{ \\"kind\\": \\"struct\\", \\"fields\\": [ [\\"symbol\\", \\"string\\"], [\\"multiplier\\", \\"u64\\"] ] }", "Output": "{ \\"kind\\": \\"struct\\", \\"fields\\": [ [\\"px\\", \\"u64\\"] ] }`, "sourceCodeURL",
					), 1000000, "", "",
				))
