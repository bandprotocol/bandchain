...
cp ~/bandchain/chain/docker-config/single-validator/priv_validator_key.json ~/.bandd/config/priv_validator_key.json
cp ~/bandchain/chain/docker-config/single-validator/node_key.json ~/.bandd/config/node_key.json
