...
bandd add-genesis-account $(bandcli keys show validator1 -a) 10000000000000stake
bandd add-genesis-account $(bandcli keys show validator2 -a) 10000000000000stake
