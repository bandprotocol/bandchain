...
# initial new node
bandd init node-validator --chain-id wenchange-bandchain
...
bandd add-genesis-account $(bandcli keys show validator1 -a) 30000000000000uband
