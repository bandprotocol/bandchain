  ...
  <div className=Styles.tableLowerContainer>
    <div className=Styles.codeTabHeader>
      <Row>
        <Col size=1.0>
          <Row>
            <Col size=1.0> <Text value="Platform" color=Colors.darkGrayText size=Text.Lg /> </Col>
      ...
      <Row>
        <Col size=1.0>
          <Row>
            <Col size=1.0> <Text value="Language" color=Colors.darkGrayText size=Text.Lg /> </Col>
