...
def test_send_tx_sync_mode_wrong_sequence_fail(requests_mock):
    ...
    assert client.send_tx_sync_mode(TEST_WRONG_SEQUENCE_MSG) == TransactionSyncMode(
        tx_hash="611F45A21BB7937E451CDE78D124218603644635CC40A97D2BC1E854CED8D6E6",
        code=4,
...
def test_send_tx_block_mode_success(requests_mock):
    ...
    assert client.send_tx_block_mode(TEST_MSG) == TransactionBlockMode(
        height="715786",
        tx_hash="2DE264D16164BCCF695E960553FED537EDC00D0E3EDF69D6BFE4168C476AD03C",
        gas_wanted="1000000",
        gas_used="1000000",
        log=[
            {
...
def test_send_tx_block_wrong_sequence_fail(requests_mock):
    ...
    assert client.send_tx_block_mode(TEST_MSG) == TransactionBlockMode(
        height="0",
        tx_hash="7F1CFFD674CAAEEB25922E9C6E9F8F8CEF7A325E25B64E8DAB070D7409FD1F72",
        gas_wanted="1000000",
        gas_used="1000000",
        code=4,
        log=[],
