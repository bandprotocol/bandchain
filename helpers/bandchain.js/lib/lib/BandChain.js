...
function _createRequestMsg() {
  _createRequestMsg = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee13(cosmos, sender, oracleScriptID, validatorCounts, calldata, chainID, fee) {
    var account;
      ...
      while (1) {
        switch (_context13.prev = _context13.next) {
          ...
          case 2:
            ...
            return _context13.abrupt("return", cosmos.newStdMsg({
              msgs: [{
                type: 'oracle/Request',
                value: {
...
var BandChain = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(BandChain, [{
    ...
    key: "getLatestValue",
    value: function () {
      var _getLatestValue = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee10(oracleScriptID, parameters) {
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 5:
                ...
                _context10.next = 8;
                return this.getLastMatchingRequestResult(oracleScript, parameters, validatorCounts);
    ...
    value: function () {
      var _getReferenceData = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee12(pairs) {
        var _this = this;
            ...
            switch (_context12.prev = _context12.next) {
              case 0:
                sourceList = [{
                  id: 8,
                  exponent: 9,
                  symbols: ['BTC', 'ETH', 'USDT', 'XRP', 'LINK', 'DOT', 'BCH', 'LTC', 'ADA', 'BSV', 'CRO', 'BNB', 'EOS', 'XTZ', 'TRX', 'XLM', 'ATOM', 'XMR', 'OKB', 'USDC', 'NEO', 'XEM', 'LEO', 'HT', 'VET']
                }, {
                  id: 8,
                  exponent: 9,
                  symbols: ['YFI', 'MIOTA', 'LEND', 'SNX', 'DASH', 'COMP', 'ZEC', 'ETC', 'OMG', 'MKR', 'ONT', 'NXM', 'AMPL', 'BAT', 'THETA', 'DAI', 'REN', 'ZRX', 'ALGO', 'FTT', 'DOGE', 'KSM', 'WAVES', 'EWT', 'DGB']
                }, {
                  id: 8,
                  exponent: 9,
                  symbols: ['KNC', 'ICX', 'TUSD', 'SUSHI', 'BTT', 'BAND', 'EGLD', 'ANT', 'NMR', 'PAX', 'LSK', 'LRC', 'HBAR', 'BAL', 'RUNE', 'YFII', 'LUNA', 'DCR', 'SC', 'STX', 'ENJ', 'BUSD', 'OCEAN', 'RSR', 'SXP']
                }, {
                  id: 8,
                  exponent: 9,
                  symbols: ['BTG', 'BZRX', 'SRM', 'SNT', 'SOL', 'CKB', 'BNT', 'CRV', 'MANA', 'YFV', 'KAVA', 'MATIC', 'TRB', 'REP', 'FTM', 'TOMO', 'ONE', 'WNXM', 'PAXG', 'WAN', 'SUSD', 'RLC', 'OXT', 'RVN', 'NANO']
                }, {
                  id: 9,
                  exponent: 9,
                  symbols: ['EUR', 'GBP', 'CNY', 'SGD', 'RMB', 'KRW', 'JPY', 'INR', 'RUB', 'CHF', 'AUD', 'BRL', 'CAD', 'HKD', 'XAU', 'XAG']
                }];
                set = new Set();
                ...
                symbolDict = {};
                _context12.next = 6;
                return Promise.all((0, _toConsumableArray2["default"])(set).map( /*#__PURE__*/function () {
                  var _ref4 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee11(index) {
                    var result;
                    return _regenerator["default"].wrap(function _callee11$(_context11) {
                      while (1) {
                        switch (_context11.prev = _context11.next) {
                          case 0:
                            _context11.next = 2;
                            return _this.getLatestValue(sourceList[index].id, {
                          ...
                          case 2:
                            ...
                            return _context11.abrupt("return", sourceList[index].symbols.map(function (symbol, id) {
                              symbolDict[symbol] = {
              ...
              case 6:
                ...
                pairs.forEach(function (pair) {
                  ...
                  if (baseSymbol == 'USD' && quoteSymbol == 'USD') {
                    ...
                    var rate = Math.pow(10, symbolDict[quoteSymbol].decimals) / Number(symbolDict[quoteSymbol].value);
                    data.push({
                      pair: pair,
                      rate: rate,
                      updated: {
                      ...
                      rawRate: {
                        value: BigInt(BigInt(Math.pow(10, symbolDict[quoteSymbol].decimals + 9)) / symbolDict[quoteSymbol].value),
                        decimals: 9
                      }
                    });
                    ...
                    data.push({
                      pair: pair,
                      rate: Number(symbolDict[baseSymbol].value) / Math.pow(10, symbolDict[baseSymbol].decimals),
                      updated: {
                    ...
                    data.push({
                      pair: pair,
                      rate: Number(symbolDict[baseSymbol].value) / Number(symbolDict[quoteSymbol].value),
                      updated: {
                        base: Number(symbolDict[baseSymbol].updated),
                        quote: Number(symbolDict[quoteSymbol].updated)
                      },
                      rawRate: {
                        value: symbolDict[baseSymbol].value * BigInt(1e9) / symbolDict[quoteSymbol].value,
                        decimals: 9
                      }
                    });
                  }
